...
const documentation = {
  ...
  sidebar: {
    automatic: {
      desktop: ['Automatically display the sidebar panel when CV5 is in small size/desktop', 'Boolean'],
      fullScreen: ['Automatically display the sidebar panel when CV5 in fullscreen size', 'Boolean'],
    },
