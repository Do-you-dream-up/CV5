...
export default function Interaction({
  ...
  const quickreplyTemplate = templatename === 'dydu_quick_reply_001';
  ...
  }, [addBubbles, carousel, children, ready, quickreplyTemplate]);
        ...
        {bubbles.length > 0 && React.createElement(
          carousel ? Carousel : 'div',
          {
            children: bubbles.map((it, index) => {
              ...
              return <Bubble className={classes.bubble} hasExternalLink={hasExternalLink} templatename={templatename} key={index} {...attributes} />;
            }),
